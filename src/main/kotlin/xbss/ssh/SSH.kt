...
//    private val session: Session
    ...
    fun initSSH(){
        ...
        val properties = Properties().apply {
            ...
            // 新增：服务器支持的密钥交换算法（从你的 ssh -vvv 输出提取）
            put(
                "KexAlgorithms",
            ...
            // 新增：服务器支持的加密算法
            put("Ciphers", "chacha20-poly1305@openssh.com,aes128-ctr,aes192-ctr,aes256-ctr,aes128-gcm@openssh.com")

            // 新增：服务器支持的 MAC 算法
            put("MACs", "hmac-sha2-256,hmac-sha2-512,hmac-sha1,chacha20-poly1305@openssh.com")

            // 新增：服务器支持的主机密钥算法
            put(
                "HostKeyAlgorithms",
                "ssh-ed25519,rsa-sha2-256,rsa-sha2-512,ecdsa-sha2-nistp256,ecdsa-sha2-nistp384,ecdsa-sha2-nistp521"
            )
