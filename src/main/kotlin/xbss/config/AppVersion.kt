 ...
 *            0.6.1 -- 2023年11月10日21:38:07：创建文件夹失败会给出提示。新增了静态通知面板
 *            0.6.2 -- 2024年2月4日12:07:49：连接面板的输入密码的时候可选择密码可见/不可见（默认不可见）
 *            0.6.3 -- 2024年2月18日21:48:32：①修复了在没有gpu的情况CPU和内存的系统数据也无法显示②修复了系统数据无法正常是显示时无法关闭的问题。
 *            0.6.4 -- 2024年8月8日21:25:03：优化了删除、复制时的逻辑，现在会分批次删除，大大提升了删除效率（0.6.4版本前删除100个文件需要约150秒，现在只需8秒钟）。
 *            0.6.4 -- 2025年11月18日20:05:42：修改了Jpackage的打包，添加了jdk.crypto.ec，不然有的算法被jlink裁掉了。
 *
 *
 *
 */
