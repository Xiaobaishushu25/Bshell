...
import xbss.myterminal.jediterm.core.typeahead.TypeAheadTerminalModel.LineWithCursorX;
...
public class TerminalTypeAheadManager {
  ...
  public static class TypeAheadEvent {
    ...
    // @see xbss.myterminal.jediterm.terminal.TerminalKeyEncoder
    ...
    /**
     * copied from xbss.myterminal.intellij.openapi.util.text.StringUtil
     */
    @Contract(pure = true)
  ...
  private @NotNull TypeAheadPrediction createPrediction(@NotNull LineWithCursorX initialLineWithCursorX,
