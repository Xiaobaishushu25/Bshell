...
import xbss.myterminal.intellij.util.concurrency.EdtExecutorService;
...
public class Alarm implements Disposable {
    private static final Logger LOG = Logger.getInstance("#xbss.myterminal.intellij.util.Alarm");
