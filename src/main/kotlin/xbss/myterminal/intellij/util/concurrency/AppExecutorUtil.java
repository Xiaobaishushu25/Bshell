 ...
 */
package xbss.myterminal.intellij.util.concurrency;
...
public class AppExecutorUtil {
   ...
   * <li>Backed by the application thread pool. I.e. every scheduled task will be executed in IDEA own thread pool. See {@link xbss.myterminal.intellij.openapi.application.Application#executeOnPooledThread(Runnable)}</li>
